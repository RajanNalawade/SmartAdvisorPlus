...
public class Adapter_BI_AnnuityPlusGrid extends BaseAdapter{
	...
	public Adapter_BI_AnnuityPlusGrid(Context context, List<M_BI_Annuity_Plus_Adapter> results) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.adapter_bi_grid_annuity_plus,
					null);
