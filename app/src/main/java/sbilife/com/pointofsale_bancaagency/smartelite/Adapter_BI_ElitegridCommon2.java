...
class Adapter_BI_ElitegridCommon2 extends BaseAdapter {
    ...
    private final List<M_BI_EliteGrid_AdapterCommon2> allElementDetails;
    ...
    public Adapter_BI_ElitegridCommon2(Context context, List<M_BI_EliteGrid_AdapterCommon2> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_elite_common2,
                    null);
            ...
            holder.ATPDChrg = convertView.findViewById(R.id.ATPDChrg);
        ...
        holder.ATPDChrg.setText(String.valueOf(allElementDetails.get(position).getATPDChrg()));
