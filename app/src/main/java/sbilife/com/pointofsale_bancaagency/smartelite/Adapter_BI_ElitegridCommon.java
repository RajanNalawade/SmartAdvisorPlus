...
public class Adapter_BI_ElitegridCommon extends BaseAdapter {
    ...
    List<M_BI_EliteGrid_AdapterCommon> allElementDetails;
    ...
    public Adapter_BI_ElitegridCommon(Context context, List<M_BI_EliteGrid_AdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_elite_common,
                    null);
