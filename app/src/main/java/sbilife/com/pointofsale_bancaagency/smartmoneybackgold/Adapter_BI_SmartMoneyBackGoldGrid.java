...
class Adapter_BI_SmartMoneyBackGoldGrid extends BaseAdapter {
    ...
    private final List<M_BI_SmartMoneyBackGold_Adapter> allElementDetails;
    ...
    public Adapter_BI_SmartMoneyBackGoldGrid(Context context, List<M_BI_SmartMoneyBackGold_Adapter> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_money_back_gold,
                    null);
