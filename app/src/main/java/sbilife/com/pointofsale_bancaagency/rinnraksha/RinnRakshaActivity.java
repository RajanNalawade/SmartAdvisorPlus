...
public class RinnRakshaActivity extends AppCompatActivity {
    ...
    private String strDate = "", strDisbursementDate;
    ...
    private String str_SBI_home_loan_type = "", str_activity_type;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Receiving the Data
        str_activity_type = getIntent().getStringExtra("RIN_RAKSHA_PREMIUM_MODE");
        ...
        ArrayAdapter<String> staffNonstaffAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, staffNonstaffList);
        ...
        ArrayAdapter<String> loanTypeAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, loanTypeList);
        ...
        ArrayAdapter<String> isJKREsidentAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, isJKResidentList);
        ...
        ArrayAdapter<String> isMoratoCheckedAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, isMoratoCheckedList);
        ...
        ArrayAdapter<String> optionListAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, optionList);
        ...
        ArrayAdapter<String> premPaidByListAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, premPaidByList);
        ...
        ArrayAdapter<String> isIntPayDuringMoratoAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, isIntPayDuringMoratoList);
        ...
        String[] premFreqList = {"Single", "Yearly"};
        ArrayAdapter<String> premFreqAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, premFreqList);
        ...
        ArrayAdapter<String> isCoBorrowerAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, isCoBorrowerList);
        ...
        ArrayAdapter<String> bankOptionListAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, bankOptionList);
...
//				if(DOB_Borrower3.getText().toString().equals("Select Date"))
//				{
//					new DatePickerDialog(RinnRakshaActivity.this,R.style.datepickerstyle,borrower3datepickerListener,mYear,mMonth,mDay).show();
//				}
//				else
//				{
...
//				}
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                if (valLoanAmt() && valMembershipDate() && valLoanDisbursmentDate() && valdisburstmentMembershipdate() && valBorrowerDetails()
                        && valAgeForAllBorrowers("Primary Borrower") &&
    ...
    private void addListenerOnSubmit() {
        ...
        isForStaffStr = isForStaff.getSelectedItem().toString().equalsIgnoreCase("Staff") ? "true" : "false";
            ...
            showAlert.setNeutralButton("OK",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            clearFocusable(disbursementDate);
                            setFocusable(disbursementDate);
...
//        }
        ...
        return true;
           /* else if (monthsBetween > 90 && !loanType.getSelectedItem().toString().equals("Home Loan")) {
                dialog("Product not allowed for old Loans more than 3 Month", true);
                clearFocusable(btn_rinnraksha_date_of_first_disbursement);
                setFocusable(btn_rinnraksha_date_of_first_disbursement);
                btn_rinnraksha_date_of_first_disbursement.requestFocus();
                return false;
            }
            else if (monthsBetween > 90 && loanType.getSelectedItem().toString().equals("Home Loan") && !rb_bank_type_SBI.isChecked()) {
                dialog("Product not allowed for old Loans more than 3 Month", true);
                clearFocusable(btn_rinnraksha_date_of_first_disbursement);
                setFocusable(btn_rinnraksha_date_of_first_disbursement);
                btn_rinnraksha_date_of_first_disbursement.requestFocus();
             ...
             else if (yearsBetween > 1095 && loanType.getSelectedItem().toString().equals("Home Loan") && rb_bank_type_SBI.isChecked()) {
                dialog("Product not allowed for old Loans more than 3 Years", true);
                clearFocusable(btn_rinnraksha_date_of_first_disbursement);
                setFocusable(btn_rinnraksha_date_of_first_disbursement);
                btn_rinnraksha_date_of_first_disbursement.requestFocus();
                return false;
       ...
       /* else if (yearsBetween > 3 && loanType.getSelectedItem().toString().equals("Home Loan") && str_SBI_home_loan_type.equalsIgnoreCase("Old Home Loan") && Integer.parseInt(lifeAssuredAge) > 60) {
            dialog("Age is not allowed ", true);
            clearFocusable(btn_rinnraksha_date_of_first_disbursement);
            setFocusable(btn_rinnraksha_date_of_first_disbursement);
            btn_rinnraksha_date_of_first_disbursement.requestFocus();
            return false;
...
//			}
    ...
    private void resetInputScreen() {
        ...
        final ArrayAdapter<String> NonStaff_HomeLoanAdapter = new ArrayAdapter<>(this, R.layout.spinner_item, prop.NonStaff_HomeLoan_old);
...
//					return "Success";
    ...
    public void getDateDiff(Date Date1, Date Date2) {
     /*   Calendar c1 = Calendar.getInstance();
        c1.setTime(Date1);
        int DAY_OF_MONTH1 = c1.get(Calendar.DAY_OF_MONTH);
        int MONTH1 = c1.get(Calendar.MONTH);
        int YEAR1 = c1.get(Calendar.YEAR);

        Calendar c2 = Calendar.getInstance();
        c2.setTime(Date2);
        int DAY_OF_MONTH2 = c2.get(Calendar.DAY_OF_MONTH);
        int MONTH2 = c2.get(Calendar.MONTH);
        int YEAR2 = c2.get(Calendar.YEAR);

        LocalDate LocalDate1 = new LocalDate(YEAR1, MONTH1, DAY_OF_MONTH1);
        LocalDate LocalDate2 = new LocalDate(YEAR2, MONTH2, DAY_OF_MONTH2);
        monthsBetween = Months.monthsBetween(LocalDate2, LocalDate1).getMonths();
        monthsBetween=monthsBetween*30;
        yearsBetween = Years.yearsBetween(LocalDate2, LocalDate1).getYears();
        yearsBetween=yearsBetween*365;
*/
...
/*
        ...
        Date date = null;
        SimpleDateFormat extdate = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        SimpleDateFormat newdate = new SimpleDateFormat(
                "yyyy-MM-dd");
        date = extdate.parse(Validtill);
