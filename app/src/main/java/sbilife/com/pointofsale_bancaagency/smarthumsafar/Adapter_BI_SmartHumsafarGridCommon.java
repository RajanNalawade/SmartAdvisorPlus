...
public class Adapter_BI_SmartHumsafarGridCommon extends BaseAdapter {
    ...
    public static class ViewHolder {
        ...
        TextView tv_guaranteed_death_benefit2;
    ...
    List<M_BI_SmartHumsafar_AdapterCommon> allElementDetails;
    ...
    public Adapter_BI_SmartHumsafarGridCommon(Context context, List<M_BI_SmartHumsafar_AdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_humsafar_common,
                    null);
            ...
            holder.tv_guaranteed_death_benefit2 = (TextView) convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_death_benefit_guaranteed2);
        ...
        holder.tv_guaranteed_death_benefit2.setText(String.valueOf(allElementDetails.get(position).getGuaranteed_death_benefit2()));
