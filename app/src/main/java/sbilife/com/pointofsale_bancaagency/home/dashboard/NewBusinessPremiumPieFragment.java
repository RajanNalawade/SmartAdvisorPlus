...
public class NewBusinessPremiumPieFragment extends Fragment implements OnChartValueSelectedListener {
    private PieChart pieChart;
    private String newbusinesspremium_trad2 = "0";
    private String newbusinesspremium_ulip2 = "0";
    ...
    public NewBusinessPremiumPieFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_newbusinesspremiumpie, container, false);
        Bundle bundle = getArguments();
        if (isAdded()) {
            if (bundle != null) {

                newbusinesspremium_trad2 = bundle.getString("newbusinesspremium_trad1");
                newbusinesspremium_ulip2 = bundle.getString("newbusinesspremium_ulip1");
                ...
                if (newbusinesspremium_trad2 == null) {
                    newbusinesspremium_trad2 = "0";
                }

                if (newbusinesspremium_ulip2 == null) {
                    newbusinesspremium_ulip2 = "0";
                }
        ...
        if (strtype2.equals("CIF")) {
            pieChart.setCenterText("New Business Premium Amount Report");
        } else {
            pieChart.setCenterText("YTD Amount Report");
        }
    ...
    private void addDataToPieChart() {
        ...
        float val1 = Float.parseFloat(newbusinesspremium_trad2);
        float val2 = Float.parseFloat(newbusinesspremium_ulip2);
        float val3 = Float.parseFloat(renewalpremium_trad2);
        float val4 = Float.parseFloat(renewalpremium_ulip2);
        ...
        if (strtype2.equals("CIF")) {
            ...
            xVals.add("NB Amount :"
					+ NBCount);
			xVals.add("Surable Amount:"+surableAmount );
        }

        if (strtype2.equals("CIF")) {
            float total = val1 + val2 + val3 + val4;
            tv_total.setText("Total : " + cfap.getStringWithout_E(total));
        } else {
        ...
        if (strtype2.equals("CIF")) {
            pieChart.setDescription("New Business Premium Amount Report");
            //pieChart.setDescriptionPosition(5f,5f);
        } else {
            pieChart.setDescription("YTD Amount Report");
        }
        ...
        colors.add(0, getResources().getColor(R.color.percentage7));
        colors.add(1, getResources().getColor(R.color.percentage8));
        ...
        Legend l = pieChart.getLegend();
        // l .setCustom(new int[] { R.color.percentage1,R.color.percentage2},
