...
public class NewPolicyPieFragment extends Fragment implements OnChartValueSelectedListener {


    private PieChart pieChart;
    private String newpolicy_trad2 = "0.0";
    private String newpolicy_ulip2 = "0.0";
    private String strtype2 = "";

    public NewPolicyPieFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_newpolicypie,
                container, false);
        Bundle bundle = getArguments();

        if (isAdded()) {
            if (bundle != null) {
                newpolicy_trad2 = bundle.getString("newpolicy_trad1");
                newpolicy_ulip2 = bundle.getString("newpolicy_ulip1");
                strtype2 = bundle.getString("strtype1");


                if (TextUtils.isEmpty(newpolicy_trad2)) {
                    newpolicy_trad2 = "0.0";
                }

                if (TextUtils.isEmpty(newpolicy_ulip2)) {
                    newpolicy_ulip2 = "0.0";
                }
            }
        ...
        if (strtype2.equals("CIF")) {
            pieChart.setCenterText("New Policy Count Report");
        } else {
            pieChart.setCenterText("YTD Report");
        }
    ...
    private void addDataToPieChart() {
       ...
       /* ArrayList<PieEntry> yvalues = new ArrayList<>();
        ...
        float val1 = Float.parseFloat(newpolicy_trad2);
        float val2 = Float.parseFloat(newpolicy_ulip2);
        yvalues.add(new PieEntry(val1, 0));
        yvalues.add(new PieEntry(val2, 1));
        ...
        PieDataSet data = new PieDataSet(entries, "Election Results");
        data.setValueFormatter(new PercentFormatter());

        pieChart.setData(data);
        if (strtype2.equals("CIF")) {
            pieChart.setDescription("New Policy Count Report");
        } else {
            pieChart.setDescription("YTD Report");
        }
        ...
        colors.add(0, getResources().getColor(R.color.percentage3));
        colors.add(1, getResources().getColor(R.color.percentage4));
