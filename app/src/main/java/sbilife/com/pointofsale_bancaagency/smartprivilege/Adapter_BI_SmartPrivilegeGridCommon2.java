...
public class Adapter_BI_SmartPrivilegeGridCommon2 extends BaseAdapter {
    ...
    List<M_BI_SmartPrivilegeAdapterCommon2> allElementDetails;
    ...
    public Adapter_BI_SmartPrivilegeGridCommon2(Context context, List<M_BI_SmartPrivilegeAdapterCommon2> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_privilege_common2,
                    null);
