...
public class Adapter_BI_SmartPrivilegeGridCommon extends BaseAdapter {
    ...
    List<M_BI_SmartPrivilegeAdapterCommon> allElementDetails;
    ...
    public Adapter_BI_SmartPrivilegeGridCommon(Context context, List<M_BI_SmartPrivilegeAdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_privilege_common,
                    null);
