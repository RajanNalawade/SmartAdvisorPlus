...
public class Adapter_BI_SmartScholargridCommon extends BaseAdapter {
    ...
    List<M_BI_SmartScholarGrid_AdapterCommon> allElementDetails;
    ...
    public Adapter_BI_SmartScholargridCommon(Context context, List<M_BI_SmartScholarGrid_AdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smartscholar_common,
                    null);
