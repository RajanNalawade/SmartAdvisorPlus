...
public class Adapter_BI_SmartScholargridCommon2 extends BaseAdapter {
    ...
    public static class ViewHolder {
        ...
        TextView PPWB_charges;
        TextView Add_ADB_ATPD_Charges;
    ...
    List<M_BI_SmartScholarGrid_AdapterCommon2> allElementDetails;
    ...
    public Adapter_BI_SmartScholargridCommon2(Context context, List<M_BI_SmartScholarGrid_AdapterCommon2> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smartscholar_common2,
                    null);
            ...
            holder.PPWB_charges = (TextView) convertView.findViewById(R.id.PPWB_charges);
            holder.Add_ADB_ATPD_Charges = (TextView) convertView.findViewById(R.id.Add_ADB_ATPD_Charges);
            holder.tv_guranteed_addition1 = (TextView) convertView.findViewById(R.id.tv_guranteed_addition1);
        ...
        holder.PPWB_charges.setText(String.valueOf(allElementDetails.get(position).getPPWB_charges()));
        holder.Add_ADB_ATPD_Charges.setText(String.valueOf(allElementDetails.get(position).getAdd_ADB_ATPD_Charges()));
