...
public class M_BI_SmartScholarGrid_AdapterCommon2 {
    String policy_year = "";
    String premium = "";
    ...
    public M_BI_SmartScholarGrid_AdapterCommon2(String policy_year, String premium, String premium_allocation_charge, String annulized_premium_allocation_charge,
                                                String mortality_charge1, String service_tax_on_mortality_charge1, String policy_administration_charge,
                                                String PPWB_charges, String Add_ADB_ATPD_Charges,
        ...
        this.PPWB_charges = PPWB_charges;
        this.Add_ADB_ATPD_Charges = Add_ADB_ATPD_Charges;
    ...
    public String getPPWB_charges() {
        return PPWB_charges;
    }

    public void setPPWB_charges(String PPWB_charges) {
        this.PPWB_charges = PPWB_charges;
    }

    public String getAdd_ADB_ATPD_Charges() {
        return Add_ADB_ATPD_Charges;
    }

    public void setAdd_ADB_ATPD_Charges(String add_ADB_ATPD_Charges) {
        Add_ADB_ATPD_Charges = add_ADB_ATPD_Charges;
    }
}
