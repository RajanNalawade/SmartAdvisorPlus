...
public class Adapter_BI_SmartIncomeProtectGridCommon extends BaseAdapter {
    ...
    private final List<M_BI_SmartIncomeProtect_AdapterCommon> allElementDetails;
    ...
    public Adapter_BI_SmartIncomeProtectGridCommon(Context context, List<M_BI_SmartIncomeProtect_AdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smartincomepreotect_common,
                    null);
            holder = new ViewHolder();


            holder.tv_end_of_year = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_end_year);
            holder.tv_total_base_premium = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_total_base_premium);
            holder.Guaranteed_additions = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_Guaranteed_additions);
            holder.tv_guaranteed_survival_benefit = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_survival_benefit_guaranteed);
            holder.tv_guaranteed_surrender_value = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_surrender_value_guaranteed);
            holder.tv_guaranteed_death_benefit = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_death_benefit_guaranteed);
            holder.tv_guaranteed_maturity_benefit = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_maturity_benefit_guaranteed);

            holder.tv_not_guaranteed_maturity_benefit_4per = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_maturity_benefit_not_guaranteed_4_percentage);
            holder.tv_not_guaranteed_cash_bonus_4per = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_cash_bonus_not_guaranteed_4_percentage);
            holder.tv_not_guaranteed_surrender_value_4per = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_surrender_value_not_guaranteed_4_percentage);

            holder.tv_not_guaranteed_maturity_benefit_8per = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_maturity_benefit_not_guaranteed_8_percentage);


            holder.tv_not_guaranteed_cash_bonus_8per = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_cash_bonus_not_guaranteed_8_percentage);


            holder.tv_not_guaranteed_surrender_value_8per = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_surrender_value_not_guaranteed_8_percentage);


            holder.tv_not_guaranteed_survival_benefit_4per = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_survival_benefit_not_guaranteed_4_percentage);
            holder.tv_not_guaranteed_survival_benefit_8per = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_survival_benefit_not_guaranteed_8_percentage);

            holder.tv_not_guaranteed_death_benefit_4per = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_death_benefit_not_guaranteed_4_percentage);
            holder.tv_not_guaranteed_death_benefit_8per = convertView.findViewById(R.id.tv_adapter_bi_grid_smart_money_back_gold_death_benefit_not_guaranteed_8_percentage);
