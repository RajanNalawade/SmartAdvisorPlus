...
public class Adapter_BI_SmartMoneyPlannertGridCommon extends BaseAdapter {
    ...
    private final List<M_BI_SmartMoneyPlanner_AdapterCommon> allElementDetails;
    ...
    public Adapter_BI_SmartMoneyPlannertGridCommon(Context context, List<M_BI_SmartMoneyPlanner_AdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smartmoneyplanner_common,
                    null);
