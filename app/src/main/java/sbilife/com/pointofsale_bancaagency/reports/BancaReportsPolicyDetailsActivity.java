...
public class BancaReportsPolicyDetailsActivity extends AppCompatActivity implements OnClickListener, DownLoadData {

    private final String METHOD_NAME_POLICY_DETAIL = "getCIFPolicyDtls";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCommonMethods.setApplicationToolbarMenu(this, "Help Desk");
    ...
    private void service_hits() {
        ...
        service = new ServiceHits(context,
                METHOD_NAME_POLICY_DETAIL, strPolicyDetailpolicyno, strCIFBDMUserId,
    ...
    class DownloadFileAsyncPolicyDetail extends
        ...
        protected String doInBackground(String... aurl) {
            try {
                ...
                try {
                    String SOAP_ACTION_POLICY_DETAIL = "http://tempuri.org/getCIFPolicyDtls";
                    androidHttpTranport.call(SOAP_ACTION_POLICY_DETAIL,
                            envelope);
    ...
    private void viewMorePolicy() {
		/*if (!txtpolicydetailno.getText().toString().contentEquals("")) {
			String User_Type = GetUserType();

			Intent intent = new Intent(context,
					PolicyDetailActivity.class);
			intent.putExtra("PolicyNo", txtpolicydetailno.getText()
					.toString());
			intent.putExtra("strUserType", User_Type);
    ...
    private void viewCustomerDetails() {
		...
		/*if (!txtpolicydetailcustcode.getText().toString()
				.contentEquals("")) {
			String User_Type = GetUserType();

			Intent intent = new Intent(context,
					CustomerDetailActivity.class);
			intent.putExtra("CustomerId", txtpolicydetailcustcode
					.getText().toString());
			intent.putExtra("strUserType", User_Type);
