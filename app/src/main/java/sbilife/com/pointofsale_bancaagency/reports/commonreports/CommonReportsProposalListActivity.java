...
public class CommonReportsProposalListActivity extends AppCompatActivity implements ServiceHits.DownLoadData, View.OnClickListener {
    private final String METHOD_NAME_PROPOSAL_LIST = "getProposalList";
    ...
    class DownloadProposalListAsync extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... aurl) {
            try {
                ...
                try {
                    String SOAP_ACTION_PROPOSAL_LIST = "http://tempuri.org/getProposalList";
