...
public class BancaReportsMandateRegistrationStatusActivity extends AppCompatActivity implements OnClickListener, DownLoadData {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCommonMethods.setApplicationToolbarMenu(this, "Mandate Registration Status");
    ...
    private void service_hits() {
        ServiceHits service = new ServiceHits(context,
                METHOD_NAME_MANDATE_REGISTRATION_STATUS, edmandateRegistrationStatusPolicyNo.getText().toString()
    ...
    class DownloadFileAsyncMandateRegistrationStatus extends
        ...
        private String mandateRegistrationStatusOutput = "", edmandateRegistrationStatusPolicyNoString = "",
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            showProgressDialog();
            edmandateRegistrationStatusPolicyNoString = edmandateRegistrationStatusPolicyNo.getText()
                    .toString();
        }
        ...
        protected String doInBackground(String... aurl) {
            try {
                ...
                request.addProperty("strPolicyNo", edmandateRegistrationStatusPolicyNoString);
    ...
    private void getMandateStatus() {
        ...
        mCommonMethods.hideKeyboard(edmandateRegistrationStatusPolicyNo, context);
        taskMandateRegistrationStatus = new DownloadFileAsyncMandateRegistrationStatus();
