...
public class ReportsAMBSMListActivity extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (strUserType.equalsIgnoreCase("SAM")) {
            mCommonMethods.setApplicationToolbarMenu(this, "BDM/AM List");
        } else {
            mCommonMethods.setApplicationToolbarMenu(this, "BSM/UM List");
        }
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        if (id == R.id.listviewChannelUserReports) {
            ...
            String listUserType = array_sort.get(info.position).getPOSITIONTYPE();

            if (strUserType.equalsIgnoreCase("SAM") ) {
                if(listUserType.equalsIgnoreCase("BDM")){
                    menu.add(0, v.getId(), 0, "CIF List");
                }else{
                    menu.add(0, v.getId(), 0, "BDM List");
                    menu.add(8, v.getId(), 0, "Revival Campaign");
                }


            } else {

                selectedListItem = array_sort.get(info.position).getPOSITIONTYPE();
                /*if(selectedListItem.equalsIgnoreCase("Unit Manager")||selectedListItem.equalsIgnoreCase("UM")) {*/
                if (Arrays.asList(getResources().getStringArray(R.array.list_um)).indexOf(selectedListItem.toLowerCase()) != -1) {
                    menu.add(0, v.getId(), 0, "Agent List");
                } else {
                    menu.add(0, v.getId(), 0, "UM List");
                    menu.add(8, v.getId(), 0, "Revival Campaign");
                }
            }

            menu.add(1, v.getId(), 0, "Persistency");
            menu.add(2, v.getId(), 0, getString(R.string.scorecardTitle));
            menu.add(3, v.getId(), 0, "NPS");
            menu.add(4, v.getId(),0, "Send SMS Alternate Process");
            menu.add(5, v.getId(),0, "Send eMandate Link");
            menu.add(6, v.getId(),0, "Send MHR Link (Agent Own Life)");
            menu.add(7, v.getId(),0, "Send Link");
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (!TextUtils.isEmpty(strCifNo)) {
            ...
            if (title.equalsIgnoreCase("BDM List")) {
                intent = new Intent(context, BancaReportsBDMUMListActivity.class);
                userType = "AM";

            } else if (title.equalsIgnoreCase("Agent List") || title.equalsIgnoreCase("UM List")) {

                /*if(array_sort.get(info.position).getPOSITIONTYPE().equalsIgnoreCase("Unit Manager")
                        ||array_sort.get(info.position).getPOSITIONTYPE().equalsIgnoreCase("UM")){*/

                if (Arrays.asList(getResources().getStringArray(R.array.list_um)).indexOf(array_sort.get(info.position).getPOSITIONTYPE().toLowerCase()) != -1) {
            ...
            }else if(title.equalsIgnoreCase("CIF List")){
                userType = "BDM";
                intent = new Intent(context,BancaReportsCIFListActivity.class);
            ...
            if (intent != null) {
                ...
                intent.putExtra("strUserType", userType);
                    ...
                    if (!response.toString().contentEquals("anyType{}")) {
                        ...
                        try {
                            ...
                            if (strBdmListErrorCOde1 == null) {
                                ...
                                /*selectedAdapter = new SelectedAdapterBdm(
                                        context, 0, lstBDMList);
        ...
        protected void onPostExecute(String unused) {
            ...
            if (running) {
                ...
                if (strBdmListErrorCOde1 == null) {
                    ...
                    if (strUserType.equalsIgnoreCase("SAM")) {
                        txtbdmlistcount.setText("Total AM : " + lstBdmListCount);
                    } else {
                        txtbdmlistcount.setText("Total BSM/UM : " + lstBdmListCount);
                    }
                    ...
                    if (strUserType.equalsIgnoreCase("SAM")) {
                        txtbdmlistcount.setText("Total AM : )");
                    } else {
                        txtbdmlistcount.setText("Total BSM/UM : )");
                    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!i) {
                if (strUserType.equalsIgnoreCase("SAM")) {
                   ...
                   /*if(lst.get(position).getPOSITIONTYPE().equalsIgnoreCase("UM")
                            ||lst.get(position).getPOSITIONTYPE().equalsIgnoreCase("Unit Manager")){*/
                    if (Arrays.asList(getResources().getStringArray(R.array.list_um)).indexOf(lst.get(position).getPOSITIONTYPE().toLowerCase()) != -1) {
