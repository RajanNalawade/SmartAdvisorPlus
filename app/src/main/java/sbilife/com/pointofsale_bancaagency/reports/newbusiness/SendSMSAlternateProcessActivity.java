...
public class SendSMSAlternateProcessActivity extends AppCompatActivity implements View.OnClickListener, ServiceHits.DownLoadData {
    ...
    private DownloadSMSAlternateProcessAsyncTask downloadSMSAlternateProcessAsyncTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_s_m_s_alternate_process);
        //getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.window_title);

        context = this;
        commonMethods = new CommonMethods();
        commonMethods.setApplicationToolbarMenu(this, "Send SMS Alternate Process");
        ...
        mProgressDialog.setButton("Cancel",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (downloadSMSAlternateProcessAsyncTask != null) {
                            downloadSMSAlternateProcessAsyncTask.cancel(true);
                        }
    ...
    public void downLoadData() {
        downloadSMSAlternateProcessAsyncTask = new DownloadSMSAlternateProcessAsyncTask();
        downloadSMSAlternateProcessAsyncTask.execute();
    }

    class DownloadSMSAlternateProcessAsyncTask extends AsyncTask<String, String, String> {
                    ...
                    if (!TextUtils.isEmpty(mobileNumber)) {
                        ...
                        dialogButton.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View v) {
                                dialog.dismiss();
                                try {
                                    SendSmsALternateProcessAsyncTask sendSmsALternateProcessAsyncTask
                                            = new SendSmsALternateProcessAsyncTask(mobileNumber);
    ...
    public class SendSmsALternateProcessAsyncTask extends AsyncTask<String, String, String> {

        private volatile boolean running = true;
        private String response = "";
        private final String mobileNumber;

        public SendSmsALternateProcessAsyncTask(String mobileNumber) {
        ...
        protected String doInBackground(String... aurl) {
            try {
                ...
                running = true;
                String NAMESPACE = "http://tempuri.org/";
                String METHOD_NAME_SEND_SMS = "sendBitlyAlternet";
