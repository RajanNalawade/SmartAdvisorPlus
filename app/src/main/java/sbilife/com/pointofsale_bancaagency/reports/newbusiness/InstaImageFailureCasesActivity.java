...
public class InstaImageFailureCasesActivity extends AppCompatActivity implements View.OnClickListener, ServiceHits.DownLoadData {
    private final String METHOD_NAME = "getPIWCStatus_InstaFailure";

    private CommonMethods commonMethods;
    private Context context;
    private String strCIFBDMUserId = "", strCIFBDMEmailId = "",
            strCIFBDMPassword = "", strCIFBDMMObileNo = "",strPIVCFlag = "";
    ...
    private PIWCInstaImageFailureAsync piwcInstaImageFailureAsync;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insta_imageailure_cases);
        //getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.window_title);
        context = this;
        commonMethods = new CommonMethods();
        commonMethods.setApplicationToolbarMenu(this, "Insta Image Verification Status");
    ...
    public void downLoadData() {
        ...
        piwcInstaImageFailureAsync = new PIWCInstaImageFailureAsync();
        piwcInstaImageFailureAsync.execute();
    }
    ...
    class PIWCInstaImageFailureAsync extends AsyncTask<String, String, String> {
    ...
    public class SelectedAdapter extends RecyclerView.Adapter<SelectedAdapter.
        ...
        public ViewHolderAdapter onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View mView = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.list_item_image_failure_cases, parent, false);
        ...
        public void onBindViewHolder(final ViewHolderAdapter holder, int position) {
            ...
            holder.tvProposalFullName.setText(lstAdapterList.get(position).getPR_FULL_NM());
            holder.tvCallDate.setText(lstAdapterList.get(position).getPL_CALL_DT());
            holder.tvRemarks.setText(lstAdapterList.get(position).getREMARKS());
            holder.textviewMobileNumber.setText(lstAdapterList.get(position).getPROPOSER_MOBILE());

            String videoCallFlag = lstAdapterList.get(position).getVD_CALL_FLAG();
            if (videoCallFlag.equalsIgnoreCase("y")) {

                String imageVerification = lstAdapterList.get(position).getVD_VERIF();

                if(imageVerification.equalsIgnoreCase("F")){
                    imageVerification = "Photo Mismatch";
                }else  if(imageVerification.equalsIgnoreCase("K")){
                    imageVerification = "KYC Image not available";
                }else  if(imageVerification.equalsIgnoreCase("N")){
                    imageVerification = "Pending for Verification";
                }else  if(imageVerification.equalsIgnoreCase("P")){
                    imageVerification = "PIVP Image not available";
                }else  if(imageVerification.equalsIgnoreCase("Y")){
                    imageVerification = "Photo Matched";
                }

                holder.tvImageVerification.setText(imageVerification);
            } else {
                holder.tvImageVerification.setText("Insta PIWC Mismatch");
        ...
        public class ViewHolderAdapter extends RecyclerView.ViewHolder{
            ...
            private final TextView tvProposalNo, tvProposalFullName, tvCallDate, tvRemarks, textviewMobileNumber,
                    tvImageVerification;
            private final ImageView imgcontact_cust_r;
            private LinearLayout llImageVerification;

            ViewHolderAdapter(View v) {
                super(v);
                tvProposalNo = v.findViewById(R.id.tvProposalNo);
                tvProposalFullName = v.findViewById(R.id.tvProposalFullName);
                tvCallDate = v.findViewById(R.id.tvCallDate);
                tvRemarks = v.findViewById(R.id.tvRemarks);

                tvImageVerification = v.findViewById(R.id.tvImageVerification);
                textviewMobileNumber = v.findViewById(R.id.textviewMobileNumber);
                imgcontact_cust_r = v.findViewById(R.id.imgcontact_cust_r);
                llImageVerification = v.findViewById(R.id.llImageVerification);
    ...
    private void killTasks() {
        ...
        if (piwcInstaImageFailureAsync != null) {
            piwcInstaImageFailureAsync.cancel(true);
        }
    ...
    public class DialogAdapterAOBRequirementDocs extends RecyclerView.Adapter<DialogAdapterAOBRequirementDocs.ViewHolderAdapter> {
        ...
        @Override
        public void onBindViewHolder(DialogAdapterAOBRequirementDocs.ViewHolderAdapter holder, final int position) {
