...
public class BancaReportsProposalTracker extends AppCompatActivity implements
        DownLoadData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // initialization
        initialise();
        mCommonMethods.setApplicationToolbarMenu(this, "Proposal Status Tracker");
	...
	public void onClick(View v) {
		...
		mCommonMethods.printLog("onClick", "proposal ok");
    ...
    private void getProposalDetails() {
        mCommonMethods.hideKeyboard(edProposalTrackerNo, mContext);
    ...
    private void service_hits() {
        ...
        ServiceHits service = new ServiceHits(mContext,
                METHOD_NAME_PROPOSAL_TRACKER, edProposalTrackerNo.getText().toString(), strCIFBDMUserId,
            ...
            if (running) {
                ...
                if (strProposalTrackerErrorCOde != null) {
                    ...
                    if (strProposalTrackerErrorCOde.equalsIgnoreCase("success")) {
                        ...
                        tblProposarTrackerStatus.setVisibility(View.GONE);
                        mCommonMethods.showMessageDialog(mContext, "Server Not Responding,Try again..");
                    }
                } else {
                    mCommonMethods.showMessageDialog(mContext, "Server Not Responding,Try again..");
                }
