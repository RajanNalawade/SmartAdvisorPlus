...
public class AgencyReportsAdvisorProposalsStatusActivity extends AppCompatActivity implements OnClickListener, DownLoadData {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        commonMethods.setApplicationToolbarMenu(this, getString(R.string.channelProposerTrackerLabel));
    ...
    private void setDates() {
        ...
        String channelProposerTodate = daeCPT + "-" + commonMethods.getFullMonthName(meCPT) + "-" + yeCPT;
                ...
                if (differenceDates <= 31) {
                    ...
                    if ((d2.after(d1)) || (d2.equals(d1))) {
                        if(commonMethods.isNetworkConnected(context)) {
                            String input = channelProposaltrackerStatusSpinner + ","
                                    +channelProposaltrackerStatusFromDate+","+channelProposaltrackerStatusToDate;
                            service_hits(input);
                        } else {
    ...
    class SelectedAdapterChannelProposalTracker extends ArrayAdapter<XMLChannelProposerTrackerStatusList> {
        ...
        final List<XMLChannelProposerTrackerStatusList> lst;
