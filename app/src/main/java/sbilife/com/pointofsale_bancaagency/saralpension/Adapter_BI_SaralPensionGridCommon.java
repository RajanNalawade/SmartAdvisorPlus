...
public class Adapter_BI_SaralPensionGridCommon extends BaseAdapter {
    ...
    List<M_BI_SaralPension_AdapterCommon> allElementDetails;
    ...
    public Adapter_BI_SaralPensionGridCommon(Context context, List<M_BI_SaralPension_AdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_saralpension_common,
                    null);
