...
public class Activity_POSP_RA_BankDetails extends AppCompatActivity implements View.OnClickListener, AsyncUploadFile_Common.Interface_Upload_File_Common {
    ...
    private boolean validate_acc_no = false, is_dashboard = false, is_back_pressed = false, is_bsm_questions = false,
            is_rejection = false;
    private StringBuilder str_bank_info = null;
    private ParseXML mParseXML;

    private ArrayList<Pojo_POSP_RA> lstRes = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_posp_ra_bank_details);
    ...
    public void initialisation() {
        ...
        mCommonMethods.setApplicationToolbarMenu1(this, "POSP_RA");
        ...
        //set Data from DB
        lstRes = db.get_posp_ra_details_by_ID(Activity_POSP_RA_Authentication.row_details);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Activity_POSP_RA_BankDetails.this, Activity_POSP_RA_Nomination.class);
        if (is_bsm_questions)
            ...
            case R.id.btn_aob_bank_next:
                 ...
                 if (is_dashboard) {
                    ...
                    if (str_error.equals("")) {
                        ...
                        if (spnr_aob_bank_account_type.getSelectedItem().toString().equals("EFT")) {
                            createSoapRequestToUploadDoc(edt_aob_bank_account_brach_code.getText().toString(),
                                    spnr_aob_bank_account_type.getSelectedItem().toString());
                        } else if (spnr_aob_bank_account_type.getSelectedItem().toString().equals("NEFT")) {
                            createSoapRequestToUploadDoc(edt_aob_bank_account_brach_ifsc.getText().toString(),
                                    spnr_aob_bank_account_type.getSelectedItem().toString());
                        }
                    } else {
    ...
    private void createSoapRequestToUploadDoc(final String strCode, final String strType) {
        ...
        new AsyncUploadFile_Common(mContext, this, request, METHOD_NAME_VERIFY_BANK_DETAILS).execute();
    }
    ...
    public void onUploadComplete(Boolean result) {
        ...
        if (result) {
            ...
            cv.put(db.POSP_RA_IN_APP_STATUS, "5");
            cv.put(db.POSP_RA_IN_APP_STATUS_REMARK, "Exam Training Info Pending");
