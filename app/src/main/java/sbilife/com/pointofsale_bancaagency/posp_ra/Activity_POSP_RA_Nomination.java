...
public class Activity_POSP_RA_Nomination extends AppCompatActivity implements View.OnClickListener,
    ...
    private final String DATE_DIALOG_APPOINTEE_DOB = "AppointeeDOB";
    private final String DATE_DIALOG_NOMINEE_DOB = "NomineeDOB";

    private int mDOBDay = 0, mDOBYear = 0, mDOBMonth = 0;
    private boolean is_nominee_pin_verify = false, is_appointee_pin_verify = false,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_posp_ra_nomination);
    ...
    public void initialisation() {
        ...
        spnr_aob_nominee_title.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 2 || position == 3) {
                    ...
                    spnr_aob_nominee_gender.setSelection(2);
                } else
        ...
        mDOBYear = mCalendar.get(Calendar.YEAR);
        mDOBMonth = mCalendar.get(Calendar.MONTH);
        mDOBDay = mCalendar.get(Calendar.DAY_OF_MONTH);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Activity_POSP_RA_Nomination.this, Activity_POSP_RA_Occupation.class);
        if (is_bsm_questions)
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_aob_nomination_next:
                ...
                if (!is_dashboard && !is_bsm_questions) {
                    ...
                    if (str_error.equals("")) {
                        ...
                        cv.put(db.POSP_RA_IN_APP_STATUS, "4");
                        cv.put(db.POSP_RA_IN_APP_STATUS_REMARK, "Bank Info Pending");
            ...
            case R.id.txt_aob_nominee_dob:
                ...
                datePickerDialog = DatePickerDialog.newInstance(Activity_POSP_RA_Nomination.this, mDOBYear, mDOBMonth, mDOBDay);
                ...
                datePickerDialog.show(getFragmentManager(), DATE_DIALOG_NOMINEE_DOB);
                break;
            ...
            case R.id.txt_aob_appointee_dob:
                ...
                //Appointee should be above 18 years.
                ...
                datePickerDialog.show(getFragmentManager(), DATE_DIALOG_APPOINTEE_DOB);
                break;
