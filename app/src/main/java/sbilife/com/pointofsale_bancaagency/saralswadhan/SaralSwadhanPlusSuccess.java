...
public class SaralSwadhanPlusSuccess extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.smartswadhanplussuccess);
        setContentView(R.layout.saralswadhanplussuccess);
