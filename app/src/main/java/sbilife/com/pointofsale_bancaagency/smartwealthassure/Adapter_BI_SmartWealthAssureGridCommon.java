...
public class Adapter_BI_SmartWealthAssureGridCommon extends BaseAdapter {
    ...
    List<M_BI_SmartWealthAssureAdapterCommon> allElementDetails;
    ...
    public Adapter_BI_SmartWealthAssureGridCommon(Context context, List<M_BI_SmartWealthAssureAdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_wealth_assure_common,
                    null);
