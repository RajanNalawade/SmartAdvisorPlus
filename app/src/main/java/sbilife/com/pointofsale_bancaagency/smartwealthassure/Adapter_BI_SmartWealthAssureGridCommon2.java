...
public class Adapter_BI_SmartWealthAssureGridCommon2 extends BaseAdapter {
    ...
    List<M_BI_SmartWealthAssureAdapterCommon2> allElementDetails;
    ...
    public Adapter_BI_SmartWealthAssureGridCommon2(Context context, List<M_BI_SmartWealthAssureAdapterCommon2> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_wealth_assure_common2,
                    null);
