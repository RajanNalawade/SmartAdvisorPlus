...
public class Adapter_BI_ShubhNiveshGridCommon extends BaseAdapter {
    ...
    List<M_BI_ShubhNivesh_AdapterCommon> allElementDetails;
    ...
    public Adapter_BI_ShubhNiveshGridCommon(Context context, List<M_BI_ShubhNivesh_AdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_shubhnivesh_common,
                    null);
