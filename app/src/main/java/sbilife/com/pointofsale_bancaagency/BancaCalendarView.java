...
public class BancaCalendarView extends AppCompatActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button btnshowcust_dob = findViewById(R.id.btnshowcust_dob);
		...
		gridview.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v,
				...
				/*selectedDayMonthYearButton.setText("Selected: "
						+ selectedGridDate);
				if (lstevent.size() > 0 && lsttime.size() > 0) {
					bteventnameButton.setText("Selected: "
							+ lstevent.get(0).toString());
					bttimename
							.setText("Selected: " + lsttime.get(0).toString());
				} else {
					bteventnameButton.setText("Selected: " + "");
					bttimename.setText("Selected: " + "");
				}*/
...
*/				}
	...
	public void showallevents(View v)
	{
		...
		if (c1.getCount() > 0) {
			...
			for (int ii = 0; ii < c1.getCount(); ii++) {
				clsCalendar single = new clsCalendar(strdate, strevent,
						strtmonth, strtyear, strtime,struserid);
				single.setDateName(c1.getString(c1
						.getColumnIndex("DateName")));
				single.setEventName(c1.getString(c1
						.getColumnIndex("EventName")));
		...
		if (lstmain.size() > 0) {
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					String rowid = db.GetRowID(date, event, time, strCIFBDMUserId);
					...
					int rowid = Integer.parseInt(g) + 1;			
						...
						if (c1.getCount() > 0) {
							...
							i.putExtra("Date", lstevent.get(0).toString());				
							i.putExtra("Event", lstevent.get(1).toString());					
	...
	public void onBackPressed() {
		Intent i = new Intent(BancaCalendarView.this, CarouselHomeActivity.class);
