...
public class ActivityAOBAgentDetails extends AppCompatActivity implements ServiceHits.DownLoadData {

    private final String NAMESPACE = "http://tempuri.org/";
    private final String METHOD_NAME_GET_AOB_AGENT_DETAILS = "getAgentDetail_smrt";
    ...
    private List<ParseXML.PojoAOBAgentDetails> lstAOBAgentDetails = new ArrayList();

    private AdapterAOBAgentDetails mAdapterAOBAgentDetails;
    private String strCIFBDMUserId = "", strCIFBDMEmailId = "", strCIFBDMMObileNo = "",
            strCIFBDMPassword = "";
    private ProgressDialog mProgressDialog;

    private AsyncGetAOBAgentDetails mAsyncGetAOBAgentDetails;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
        setContentView(R.layout.activity_aobagent_details);
        ...
        mCommonMethods.setApplicationToolbarMenu(this, "Agent Details");
        ...
        mAdapterAOBAgentDetails = new AdapterAOBAgentDetails(mContext, lstAOBAgentDetails);
        rvAgentDetails.setAdapter(mAdapterAOBAgentDetails);
        ...
        edt_search_by_all.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mAdapterAOBAgentDetails.getFilter().filter(s);
            }
    ...
    public void downLoadData() {
        if (mCommonMethods.isNetworkConnected(mContext)){
            mAsyncGetAOBAgentDetails = new AsyncGetAOBAgentDetails();
    ...
    private void service_hits() {
        ServiceHits service = new ServiceHits(mContext,
                METHOD_NAME_GET_AOB_AGENT_DETAILS, "", strCIFBDMUserId,
                strCIFBDMEmailId, strCIFBDMMObileNo,
                strCIFBDMPassword, this);
        service.execute();
    }

    class AsyncGetAOBAgentDetails extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... aurl) {
            try {
                ...
                request = new SoapObject(NAMESPACE, METHOD_NAME_GET_AOB_AGENT_DETAILS);
                ...
                try {
                    ...
                    androidHttpTranport.call(NAMESPACE + METHOD_NAME_GET_AOB_AGENT_DETAILS, envelope);
                    ...
                    if (!response.toString().contentEquals("anyType{}")) {
                        ...
                        if (!strResponce.equals("") || !strResponce.equals("0")) {
                            ...
                            lstAOBAgentDetails = prsObj.parseNodeAOBAgentDetails(Node, "ActivityAOBAgentDetails");
        ...
        protected void onPostExecute(String unused) {
            ...
            if (running) {
                if (!strError.equals("")) {
                    ...
                    if (lstAOBAgentDetails.size() == 0) {
                        txtTotalCount.setText("Total : " + lstAOBAgentDetails.size());
                        edt_search_by_all.setVisibility(View.GONE);
                    } else {
                        txtTotalCount.setText("Total : " + lstAOBAgentDetails.size());
                    }
    ...
    public class AdapterAOBAgentDetails extends RecyclerView.Adapter<AdapterAOBAgentDetails.ViewHolderAdapter> implements Filterable {

        private final Context mAdapterContext;
        private List<ParseXML.PojoAOBAgentDetails> lstAdapterList, lstSearch;

        AdapterAOBAgentDetails(Context mAdapterContext, List<ParseXML.PojoAOBAgentDetails> lstAdapterList) {
        ...
        public Filter getFilter() {
            ...
            return new Filter() {
                ...
                protected FilterResults performFiltering(CharSequence charSequence) {
                    ...
                    final ArrayList<ParseXML.PojoAOBAgentDetails> results = new ArrayList<>();
                    ...
                    if (!strSearch.equals("")) {
                        if (lstSearch != null && lstSearch.size() > 0) {
                            for (final ParseXML.PojoAOBAgentDetails g : lstSearch) {
                                if (g.getStrIACode().toLowerCase().contains(charSequence.toString().toLowerCase())
                                        ...
                                        || g.getStrIAName().toLowerCase().contains(charSequence.toString().toLowerCase())
                                )
                                    results.add(g);
                            }
                        }
                        ...
                        oReturn.values = lstAOBAgentDetails;
                    }
                    return oReturn;
                }
                ...
                protected void publishResults(CharSequence constraint, FilterResults results) {
                    ...
                    lstAdapterList = (List<ParseXML.PojoAOBAgentDetails>) results.values;
        ...
        public void onBindViewHolder(ViewHolderAdapter holder, int position) {
            ...
            String strUserName = lstAdapterList.get(position).getStrIAName() == null ? "" : lstAdapterList.get(position).getStrIAName();

            holder.txtTitleUserName.setText("IA Name : ");
                holder.txtValueUserName.setText(strUserName);
            }
            ...
            ViewHolderAdapter(View v) {
                ...
                v.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        ...
                        Intent mIntent = new Intent(ActivityAOBAgentDetails.this, ActivityAOBAgentReqDoc.class);
