...
public class ActivityAOBOccupation extends AppCompatActivity implements View.OnClickListener,
        AdapterView.OnItemSelectedListener, DatePickerDialog.OnDateSetListener {

    private final String DATE_EMPLOYMENT_LAST_DATE = "EmploymentLastDate";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aob_occupation);
    ...
    public void initialisation() {
        ...
        if (is_ia_upgrade){
            ...
            txt_aob_occupation_formIA.setVisibility(View.GONE);
        } else{
        ...
        ArrayAdapter<String> agency_adapter = new ArrayAdapter<String>(
                mContext, R.layout.spinner_aob, getResources().getStringArray(R.array.arr_aob_occu_agency));
        ...
        if (lstRes.size() > 0) {
            ...
            if (!str_occupational_info.equals("")) {
                ...
                spnr_aob_occu_agency.setSelection(Arrays.asList(getResources().
                        getStringArray(R.array.arr_aob_occu_agency)).indexOf(str_occu_agency));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_aob_occupation_next:
                ...
                if (is_dashboard) {
                    ...
                    if (str_error.equals("")) {
                        ...
                        cv.put(db.AGENT_ON_BOARDING_SYNCH_STATUS, "3");
            ...
            case R.id.txt_aob_occu_employment_last_date:
                ...
                datePickerDialog = DatePickerDialog.newInstance(ActivityAOBOccupation.this, mYear, mMonth, mDay);
                ...
                datePickerDialog.setTitle("Employment Last Date");
