...
public class ActivityAOBInterviewBSM extends AppCompatActivity implements View.OnClickListener {
    private final String NAMESPACE = "http://tempuri.org/";

    private final String METHOD_NAME_AM_BDM_LIST = "saveBSMQues_Agentonboard";
    ...
    private EditText edt_aob_bsm_interview_q1, edt_aob_bsm_interview_q2, edt_aob_bsm_interview_q3, edt_aob_bsm_interview_q4,
            edt_aob_bsm_interview_q5, edt_ia_upgrade_rejection_remark;
    private CheckBox chkbox_aob_bsm_interview_clarify;

    private Button btn_aob_bsm_interview_next, btn_ia_upgrade_interview_reject;

    private StringBuilder str_bsm_questions_details;
    private String PANNumber = "", UMCode = "", enrollment_type = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aob_interview_bsm);
        ...
        enrollment_type = getIntent().getStringExtra("enrollment_type");
        initialisation();
    }
    ...
    public void initialisation() {
        ...
        spnr_aob_bsm_interview_q1 = (Spinner) findViewById(R.id.spnr_aob_bsm_interview_q1);
        ...
        edt_aob_bsm_interview_q1 = (EditText) findViewById(R.id.edt_aob_bsm_interview_q1);
        ...
        spnr_aob_bsm_interview_q2 = (Spinner) findViewById(R.id.spnr_aob_bsm_interview_q2);
        ...
        edt_aob_bsm_interview_q2 = (EditText) findViewById(R.id.edt_aob_bsm_interview_q2);
        ...
        edt_aob_bsm_interview_q3 = (EditText) findViewById(R.id.edt_aob_bsm_interview_q3);
        edt_aob_bsm_interview_q4 = (EditText) findViewById(R.id.edt_aob_bsm_interview_q4);
        edt_aob_bsm_interview_q5 = (EditText) findViewById(R.id.edt_aob_bsm_interview_q5);

        btn_aob_bsm_interview_next = (Button) findViewById(R.id.btn_aob_bsm_interview_next);
        btn_aob_bsm_interview_next.setOnClickListener(this);

        btn_ia_upgrade_interview_reject = findViewById(R.id.btn_ia_upgrade_interview_reject);
        btn_ia_upgrade_interview_reject.setOnClickListener(this);

        edt_ia_upgrade_rejection_remark = findViewById(R.id.edt_ia_upgrade_rejection_remark);

        if (enrollment_type.equals("IA Upgrade")) {
            btn_ia_upgrade_interview_reject.setVisibility(View.VISIBLE);
        } else {
            btn_ia_upgrade_interview_reject.setVisibility(View.GONE);
        }

        chkbox_aob_bsm_interview_clarify = (CheckBox) findViewById(R.id.chkbox_aob_bsm_interview_clarify);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_ia_upgrade_interview_reject:
                edt_ia_upgrade_rejection_remark.setVisibility(View.VISIBLE);
                edt_ia_upgrade_rejection_remark.requestFocus();
                String strRemark = edt_ia_upgrade_rejection_remark.getText().toString();
    ...
    private void onRejectClick() {
        ...
        str_bsm_questions_details.append("<REMARKS>" + edt_ia_upgrade_rejection_remark.getText().toString() + "</REMARKS>");
        ...
        str_bsm_questions_details.append("<TYPE>IA</TYPE>");
        str_bsm_questions_details.append("<SUB_TYPE>" + enrollment_type + "</SUB_TYPE>");

        str_bsm_questions_details.append("</t_bsm>");

        asyncTaskAOBPANPendingAgentList = new AsyncTaskAOBPANPendingAgentList();
        asyncTaskAOBPANPendingAgentList.execute(METHOD_NAME_REJECT_BY_BSM);
    }
    ...
    public void onNextClick() {
        ...
        if (str_error.equals("")) {
           ...
           /* ContentValues cv = new ContentValues();
            cv.put(DatabaseHelper.AGENT_ON_BOARDING_BSM_INTERVIEW_QUE, str_bsm_questions_details.toString());
            cv.put(DatabaseHelper.AGENT_ON_BOARDING_UPDATED_BY, mCommonMethods.GetUserCode(mContext));

            Calendar c = Calendar.getInstance();
            //save date in long
            cv.put(DatabaseHelper.AGENT_ON_BOARDING_UPDATED_DATE, new Date(c.getTimeInMillis()).getTime() +"");
            cv.put(DatabaseHelper.AGENT_ON_BOARDING_SYNCH_STATUS, "8");

            int i = db.update_agent_on_boarding_details(cv, DatabaseHelper.AGENT_ON_BOARDING_ID + " =? ",
                    new String[]{Activity_AOB_Authentication.row_details+""});

            mCommonMethods.showToast(mContext, "Details saved Successfully : " + i);*/
            asyncTaskAOBPANPendingAgentList = new AsyncTaskAOBPANPendingAgentList();
            asyncTaskAOBPANPendingAgentList.execute(METHOD_NAME_AM_BDM_LIST);
    ...
    class AsyncTaskAOBPANPendingAgentList extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strTypes) {
            try {
                ...
                if (strTypes[0].equals(METHOD_NAME_AM_BDM_LIST)) {
                ...
                try {
                    ...
                    if (strTypes[0].equals(METHOD_NAME_AM_BDM_LIST)) {
                        androidHttpTranport.call(NAMESPACE + METHOD_NAME_AM_BDM_LIST, envelope);
                    } else if (strTypes[0].equals(METHOD_NAME_REJECT_BY_BSM)) {
