...
public class ActivityAOBPersonalInfo extends AppCompatActivity implements View.OnClickListener,
        AdapterView.OnItemSelectedListener, AsyncUploadFile_Common.Interface_Upload_File_Common,
        DatePickerDialog.OnDateSetListener {

    private final String DATE_APPLICANT_DOB = "ApplicantDOB";
    private final String DATE_APPLICANT_PASS_YEAR_MONTH = "ApplicantPassYear";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aob_personal_info);
    ...
    public void initialisation() {
        ...
        if (is_ia_upgrade){
            ...
            view_aob_personal_formIA.setVisibility(View.GONE);
        } else{
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        switch (parent.getId()) {
            ...
            case R.id.spnr_aob_personal_title:
                ...
                edt_aob_personal_maiden_name.setText("");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.txt_aob_personal_dob:
                ...
                datePickerDialog = DatePickerDialog.newInstance(ActivityAOBPersonalInfo.this, mDOBYear, mDOBMonth, mDOBDay);
            ...
            case R.id.txt_aob_personal_pass_year_month:
                datePickerDialog = DatePickerDialog.newInstance(ActivityAOBPersonalInfo.this,
