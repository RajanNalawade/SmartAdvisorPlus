...
public class ProcessInfo {
	...
	eKYCActivity meKYCActivity = null;
	...
	/*public Integrate_serviceActivity getIntegrate_serviceActivity() {
		return integrate_serviceActivity;
	}

	public void setIntegrate_serviceActivity(
			Integrate_serviceActivity integrate_serviceActivity) {
		this.integrate_serviceActivity = integrate_serviceActivity;
	}

	public PersonalDetailActivity getPersonalDetailActivity() {
		return personalDetailActivity;
	}

	public void setPersonalDetailActivity(
			PersonalDetailActivity PersonalDetailActivity) {
		this.personalDetailActivity = PersonalDetailActivity;
	}*/

	public eKYCActivity geteKYCActivity() {
		return meKYCActivity;
	}

	public void seteKYCActivity(eKYCActivity meKYCActivity) {
		this.meKYCActivity = meKYCActivity;
	}
	...
	public void setStrategyAcquisitionMode(
			StrategyAcquisitionMode strategyAcquisitionMode) {
