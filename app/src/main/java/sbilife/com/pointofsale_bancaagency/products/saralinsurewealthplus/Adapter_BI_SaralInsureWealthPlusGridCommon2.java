...
public class Adapter_BI_SaralInsureWealthPlusGridCommon2 extends BaseAdapter {
    ...
    List<M_BI_SaralInsureWealthPlusAdapterCommon2> allElementDetails;
    ...
    public Adapter_BI_SaralInsureWealthPlusGridCommon2(Context context, List<M_BI_SaralInsureWealthPlusAdapterCommon2> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_saralinsurewealthplus_common2,
                    null);
