...
public class Adapter_BI_SmartInsureWealthPlusGridCommon2 extends BaseAdapter {
    ...
    List<M_BI_SmartInsureWealthPlusAdapterCommon2> allElementDetails;
    ...
    public Adapter_BI_SmartInsureWealthPlusGridCommon2(Context context, List<M_BI_SmartInsureWealthPlusAdapterCommon2> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smartinsurewealthplus_common2,
                    null);
