...
public class M_BI_SaralInsureWealthPlusAdapterCommon {
    String policy_year = "";
    String premium = "";
    ...
    public M_BI_SaralInsureWealthPlusAdapterCommon(String policy_year, String premium, String mortality_charge1,
