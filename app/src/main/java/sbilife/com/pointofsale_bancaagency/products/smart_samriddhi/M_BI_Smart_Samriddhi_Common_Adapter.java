...
public class M_BI_Smart_Samriddhi_Common_Adapter {

    String end_of_year = "";
    String yearly_basic_premium = "";
    String SurvivalBenefits = "";
    String OtherBenefitsifAny = "";
    ...
    public M_BI_Smart_Samriddhi_Common_Adapter(String end_of_year,
