...
public class Adapter_BI_SaralPensionNewGrid extends BaseAdapter {
    ...
    List<M_BI_Annuity_Plus_Adapter> allElementDetails;
    ...
    public Adapter_BI_SaralPensionNewGrid(Context context, List<M_BI_Annuity_Plus_Adapter> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_saral_pension_new,
                    null);
