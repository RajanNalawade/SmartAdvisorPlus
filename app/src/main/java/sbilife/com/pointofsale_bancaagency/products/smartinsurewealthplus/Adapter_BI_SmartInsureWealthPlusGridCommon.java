...
public class Adapter_BI_SmartInsureWealthPlusGridCommon extends BaseAdapter {
    ...
    public static class ViewHolder {
        ...
        TextView tv_return_of_moratlity_charge1;
        ...
        TextView tv_return_of_moratlity_charge2;
    ...
    List<M_BI_SmartInsureWealthPlusAdapterCommon> allElementDetails;
    ...
    public Adapter_BI_SmartInsureWealthPlusGridCommon(Context context, List<M_BI_SmartInsureWealthPlusAdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smartinsurewealthplus_common,
                    null);
            ...
            holder.tv_return_of_moratlity_charge1 = (TextView) convertView.findViewById(R.id.tv_return_of_moratlity_charge1);
            ...
            holder.tv_return_of_moratlity_charge2 = (TextView) convertView.findViewById(R.id.tv_return_of_moratlity_charge2);
        ...
        holder.tv_return_of_moratlity_charge1.setText(String.valueOf(allElementDetails.get(position).getTv_return_of_moratlity_charge1()));
        ...
        holder.tv_return_of_moratlity_charge2.setText(String.valueOf(allElementDetails.get(position).getTv_return_of_moratlity_charge2()));
