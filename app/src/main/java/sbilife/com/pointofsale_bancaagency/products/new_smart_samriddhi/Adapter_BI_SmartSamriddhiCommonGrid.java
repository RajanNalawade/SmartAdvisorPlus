...
public class Adapter_BI_SmartSamriddhiCommonGrid extends BaseAdapter {
    ...
    List<M_BI_Smart_Samriddhi_Common_Adapter> allElementDetails;
    ...
    public Adapter_BI_SmartSamriddhiCommonGrid(Context context, List<M_BI_Smart_Samriddhi_Common_Adapter> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_samriddhi_common,
                    null);
