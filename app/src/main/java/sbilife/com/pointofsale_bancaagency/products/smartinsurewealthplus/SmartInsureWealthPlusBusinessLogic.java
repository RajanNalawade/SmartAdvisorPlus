...
public class SmartInsureWealthPlusBusinessLogic {

    public CommonForAllProd cfap = null;
    public SmartInsureWealthPlusProperties prop = null;
    public SmartInsureWealthPlusBean smartInsureWealthPlusBean = null;
    ...
    String month_E = "0",
            ...
            ServiceTaxOnAllocation_RIY = "0",
            amountAvailableForInvestment_N = "0",
            amountAvailableForInvestment_N1 = "0",
            ...
            serviceTaxOnFMCReductionYield_Y = "0",
            fundValueAfterFMCBerforeGAReductionYield_Z = "0",
            totalServiceTaxReductionYield_U = "0",
            fundValueAtEndReductionYield_AB = "0",
            surrenderChargesReductionYield_AC = "0",
            serviceTaxOnSurrenderChargesReductionYield_AD = "0",
            surrenderValueReductionYield_AE = "0",
            deathBenefitReductionYield_AF = "0",
            serviceTaxOnFMCReductionYield_AN = "0",
            fundValueAfterFMCBerforeGAReductionYield_AO = "0",
            totalServiceTaxReductionYield_AJ = "0",
            fundValueAtEndReductionYield_AQ = "0",
            surrenderChargesReductionYield_AR = "0",
            serviceTaxOnSurrenderChargesReductionYield_AS = "0",
            surrenderValueReductionYield_AT = "0",
            deathBenefitReductionYield_AU = "0",
            month_BB = "0",
            reductionYield_BI = "0",
            reductionYield_BD = "0",
            irrAnnual_BD = "0",
            ...
            reductionInYieldNumberOfYearsElapsedSinceInception = "0", TerminalAddition = "0", AccTPDCharges = "0",
            AccTPDCharges_8p = "0", MortalityCharges_RIY = "0", MortalityCharges_RIY8 = "0", AccTPDCharges_RIY = "0",
            AccTPDCharges_RIY8 = "0",
            TotalCharges_RIY = "0", TotalCharges_RIY8 = "0", ServiceTax_exclOfSTonAllocAndSurr_RIY = "0",
            ServiceTax_exclOfSTonAllocAndSurr_RIY8 = "0", AdditionToFundIfAny_RIY = "0", AdditionToFundIfAny_RIY8 = "0",
            FundBeforeFMC_RIY = "0", FundBeforeFMC_RIY8 = "0", FundManagementCharge_RIY = "0", FundManagementCharge_RIY8 = "0",
            ServiceTaxOnFMC_RIY = "0", ServiceTaxOnFMC_RIY8 = "0", TotalServiceTax_RIY = "0", TotalServiceTax_RIY8 = "0",
            FundValueAfterFMCAndBeforeGA_RIY = "0", FundValueAfterFMCAndBeforeGA_RIY8 = "0", FundValueAtEnd_RIY = "0",
            FundValueAtEnd_RIY8 = "0", AmountAvailableForInvestment_RIY = "0", SurrenderCharges_RIY = "0",
            SurrenderCharges_RIY8 = "0", ServiceTaxOnSurrenderCharges_RIY = "0", ServiceTaxOnSurrenderCharges_RIY8 = "0",
            SurrenderValue_RIY = "0", SurrenderValue_RIY8 = "0", DeathBenefit_RIY = "0", DeathBenefit_RIY8 = "0",
            GuaranteedAddition_RIY8 = "0";

    public SmartInsureWealthPlusBusinessLogic() {
    ...
    public double getServiceTax() {
        ...
        if ((smartInsureWealthPlusBean.isKerlaDisc() == true) && Integer.parseInt(getYear_F()) <= 2) {
            return 0.19;
        } else {
            return 0.18;
        }
    ...
    public String[] getForBIArr(double mortalityCharges_AsPercentOfofLICtable) {
        ...
        SmartInsureWealthPlusDB smartInvestPlusDB = new SmartInsureWealthPlusDB();
        for (int i = 0; i < smartInvestPlusDB.getIAIarray().length - 2; i++) {
            ...
            strArrTReturn[i] = String.valueOf(((smartInvestPlusDB.getIAIarray()[i] + smartInvestPlusDB.getIAIarray()[i + 1]) / 2) * mortalityCharges_AsPercentOfofLICtable);
...
//    	System.out.println("Month "+ getMonth_E());
...
//            System.out.println("b RY"+b);
                ...
                //System.out.println(" mortalityCharges_R "+cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(((a*Math.max(b, 0))*c))));
...
//            this.additionToFundIfAny_V= cfap.roundUp_Level2( cfap.getStringWithout_E(temp1*temp2));
    ...
    public void setFundBeforeFMC_W(double _fundValueAtEnd_AB, int policyTerm, double riderCharges) {
        ...
        if (Integer.parseInt(getYear_F()) <= policyTerm) {
//        	System.out.println("_fundValueAtEnd_AB"  +_fundValueAtEnd_AB);
//        	System.out.println("Double.parseDouble(getAmountAvailableForInvestment_N())"  +Double.parseDouble(getAmountAvailableForInvestment_N()));
//        	System.out.println("Double.parseDouble(getAdditionToFundIfAny_V())"  +Double.parseDouble(getAdditionToFundIfAny_V()));
//        	System.out.println("Double.parseDouble(getTotalCharges_S())"  +Double.parseDouble(getTotalCharges_S()));
//        	System.out.println("Double.parseDouble(getServiceTax_exclOfSTonAllocAndSurr_T())"  +Double.parseDouble(getServiceTax_exclOfSTonAllocAndSurr_T()));
//        	System.out.println("riderCharges"  +riderCharges);
//        	System.out.println("fundBeforeFMC_W"  +cfap.getStringWithout_E(_fundValueAtEnd_AB+Double.parseDouble(getAmountAvailableForInvestment_N()) +Double.parseDouble(getAdditionToFundIfAny_V()) - Double.parseDouble(getTotalCharges_S())-Double.parseDouble(getServiceTax_exclOfSTonAllocAndSurr_T())+riderCharges));
...
//            	this.fundManagementCharge_X=cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(Double.parseDouble(getFundBeforeFMC_W()) * (getCharge_fund_ren( percentToBeInvested_EquityFund, percentToBeInvested_EquityOptFund, percentToBeInvested_GrowthFund, percentToBeInvested_BalancedFund,percentToBeInvested_PureFund,percentToBeInvested_MidcapFund,percentToBeInvested_BondOptFund,percentToBeInvested_CorpFund)/12)));
            double a = getCharge_fund_ren(percentToBeInvested_EquityFund, percentToBeInvested_EquityOptFund, percentToBeInvested_GrowthFund, percentToBeInvested_BalancedFund, percentToBeInvested_PureFund, percentToBeInvested_MidcapFund, percentToBeInvested_BondOptFund, percentToBeInvested_CorpFund, percentToBeInvested_MoneyMarketFund, autoAssetAllocationStrategy, policyTerm);
...
//        	System.out.println("getFundBeforeFMC_W b "+b);
            ...
            this.fundManagementCharge_X = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(Double.parseDouble(getFundBeforeFMC_W()) * getCharge_fund_ren(percentToBeInvested_EquityFund, percentToBeInvested_EquityOptFund, percentToBeInvested_GrowthFund, percentToBeInvested_BalancedFund, percentToBeInvested_PureFund, percentToBeInvested_MidcapFund, percentToBeInvested_BondOptFund, percentToBeInvested_CorpFund, percentToBeInvested_MoneyMarketFund, autoAssetAllocationStrategy, policyTerm) / 12));
            //System.out.println("fundManagementCharge_X "+fundManagementCharge_X);
//            }
        } else {
...
//    			System.out.println("a "+a+" value "+ (0.70*prop.FMC_EquityFund+0.30*prop.FMC_CorpFund+0*prop.FMC_MoneyMarketFund));
                return 0.70 * prop.FMC_EquityFund +
                        0.30 * prop.FMC_CorpFund +
                        0 * prop.FMC_MoneyMarketFund
...
//				System.out.println("a "+a+" value "+ (0.65*prop.FMC_EquityFund+0.35*prop.FMC_CorpFund+0*prop.FMC_MoneyMarketFund));
                ...
                return 0.65 * prop.FMC_EquityFund +
                        0.35 * prop.FMC_CorpFund +
                        0 * prop.FMC_MoneyMarketFund
...
//				System.out.println("a "+a+" value "+ (0.60*prop.FMC_EquityFund+0.40*prop.FMC_CorpFund+0*prop.FMC_MoneyMarketFund));
                ...
                return 0.60 * prop.FMC_EquityFund +
                        0.40 * prop.FMC_CorpFund +
                        0 * prop.FMC_MoneyMarketFund

                        ;
            } else if (a == 25) {

//				System.out.println("a "+a+" value "+ (0.55*prop.FMC_EquityFund+0.45*prop.FMC_CorpFund+0*prop.FMC_MoneyMarketFund));

                return 0.55 * prop.FMC_EquityFund +
                        0.45 * prop.FMC_CorpFund +
                        0 * prop.FMC_MoneyMarketFund

                        ;
            } else if (a == 26) {

//				System.out.println("a "+a+" value "+ (0.50*prop.FMC_EquityFund+0.50*prop.FMC_CorpFund+0*prop.FMC_MoneyMarketFund));

                return 0.50 * prop.FMC_EquityFund +
                        0.50 * prop.FMC_CorpFund +
                        0 * prop.FMC_MoneyMarketFund

                        ;
            } else if (a == 27) {

//				System.out.println("a "+a+" value "+ (0.45*prop.FMC_EquityFund+0.55*prop.FMC_CorpFund+0*prop.FMC_MoneyMarketFund));

                return 0.45 * prop.FMC_EquityFund +
                        0.55 * prop.FMC_CorpFund +
                        0 * prop.FMC_MoneyMarketFund

                        ;
            } else if (a == 28) {

//				System.out.println("a "+a+" value "+ (0.40*prop.FMC_EquityFund+0.60*prop.FMC_CorpFund+0*prop.FMC_MoneyMarketFund));

                return 0.40 * prop.FMC_EquityFund +
                        0.60 * prop.FMC_CorpFund +
                        0 * prop.FMC_MoneyMarketFund

                        ;
            } else if (a == 29) {

//				System.out.println("a "+a+" value "+ (0.35*prop.FMC_EquityFund+0.65*prop.FMC_CorpFund+0*prop.FMC_MoneyMarketFund));

                return 0.35 * prop.FMC_EquityFund +
                        0.65 * prop.FMC_CorpFund +
                        0 * prop.FMC_MoneyMarketFund
...
//				System.out.println("a "+a+" value "+ (0.30*prop.FMC_EquityFund+0.65*prop.FMC_CorpFund+0.05*prop.FMC_MoneyMarketFund));
                ...
                return 0.30 * prop.FMC_EquityFund +
                        0.65 * prop.FMC_CorpFund +
                        0.05 * prop.FMC_MoneyMarketFund
...
//				System.out.println("a "+a+" value "+ (0.25*prop.FMC_EquityFund+0.65*prop.FMC_CorpFund+0.10*prop.FMC_MoneyMarketFund));
                ...
                return 0.25 * prop.FMC_EquityFund +
                        0.65 * prop.FMC_CorpFund +
                        0.10 * prop.FMC_MoneyMarketFund
                ...
                return 0.20 * prop.FMC_EquityFund +
                        0.65 * prop.FMC_CorpFund +
                        0.15 * prop.FMC_MoneyMarketFund
                ...
                return 0.15 * prop.FMC_EquityFund +
                        0.65 * prop.FMC_CorpFund +
                        0.20 * prop.FMC_MoneyMarketFund
                ...
                return 0.10 * prop.FMC_EquityFund +
                        0.65 * prop.FMC_CorpFund +
                        0.25 * prop.FMC_MoneyMarketFund
                ...
                return 0.05 * prop.FMC_EquityFund +
                        0.65 * prop.FMC_CorpFund +
                        0.30 * prop.FMC_MoneyMarketFund
...
//        this.serviceTaxOnFMC_Y = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(a* serviceTax));
    ...
    public void setServiceTaxOnFMC_RIY(double percentToBeInvested_EquityFund, double percentToBeInvested_EquityOptFund, double percentToBeInvested_GrowthFund, double percentToBeInvested_BalancedFund, double percentToBeInvested_PureFund, double percentToBeInvested_MidcapFund, double percentToBeInvested_BondOptFund, double percentToBeInvested_CorpFund, double percentToBeInvested_MoneyMarketFund, boolean autoAssetAllocationStrategy, int policyTerm, double serviceTax) {
        ...
        //this.serviceTaxOnFMC_Y = cfap.roundUp_Level2(cfap.getStringWithout_E(a* serviceTax));
        this.ServiceTaxOnFMC_RIY = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(temp * serviceTax * a));
    ...
    public void setServiceTaxOnFMC_RIY8(double percentToBeInvested_EquityFund, double percentToBeInvested_EquityOptFund, double percentToBeInvested_GrowthFund, double percentToBeInvested_BalancedFund, double percentToBeInvested_PureFund, double percentToBeInvested_MidcapFund, double percentToBeInvested_BondOptFund, double percentToBeInvested_CorpFund, double percentToBeInvested_MoneyMarketFund, boolean autoAssetAllocationStrategy, int policyTerm, double serviceTax) {
        ...
        //this.serviceTaxOnFMC_Y = cfap.roundUp_Level2(cfap.getStringWithout_E(a* serviceTax));
        this.ServiceTaxOnFMC_RIY8 = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(temp * serviceTax * a));
    ...
    public void setFundValueAfterFMCAndBeforeGA_Z(int policyTerm) {
        if (Integer.parseInt(getYear_F()) <= policyTerm) {
        	/*System.out.println("Double.parseDouble(getFundBeforeFMC_W())" +Double.parseDouble(getFundBeforeFMC_W()));
        	System.out.println("" +);
        	System.out.println("" +);
        	System.out.println("" +);*/
    ...
    public void setTotalServiceTax_U(double riderCharges, double serviceTax) {
        ...
        this.totalServiceTax_U = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(temp1 + temp2 * serviceTax));
    }
    ...
    public void setTotalServiceTax_RIY(double riderCharges, double serviceTax) {
        ...
        this.TotalServiceTax_RIY = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(temp1 + temp2 * serviceTax));
    }
    ...
    public void setTotalServiceTax_RIY8(double riderCharges, double serviceTax) {
        ...
        this.TotalServiceTax_RIY8 = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(temp1 + temp2 * serviceTax));
    }
...
//	        	System.out.println("val2 "+val2);
    ...
    public void setFundValueAtEnd_AB() {
        System.out.println("Double.parseDouble(getGuaranteedAddition_AA())" + Double.parseDouble(getGuaranteedAddition_AA()));
        System.out.println("Double.parseDouble(getFundValueAfterFMCAndBeforeGA_Z())" + Double.parseDouble(getFundValueAfterFMCAndBeforeGA_Z()));
        System.out.println("Double.parseDouble(getTerminalAddition())" + Double.parseDouble(getTerminalAddition()));
        System.out.println("fundValueAtEnd_AB" + (Double.parseDouble(getGuaranteedAddition_AA()) + Double.parseDouble(getFundValueAfterFMCAndBeforeGA_Z()) + Double.parseDouble(getTerminalAddition())));
...
//        if(premiumamount<=25000)
    ...
    public void setServiceTaxOnSurrenderCharges_AD(double serviceTax) {
        if (prop.surrenderCharges) {
            ...
            this.serviceTaxOnSurrenderCharges_AD = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(Double.parseDouble(getSurrenderCharges_AC()) * serviceTax));
        } else {
    ...
    public void setServiceTaxOnSurrenderCharges_RIY(double serviceTax) {
        if (prop.surrenderChargesYield) {
            //this.serviceTaxOnSurrenderCharges_AD =cfap.roundUp_Level2(cfap.getStringWithout_E(Double.parseDouble(getSurrenderCharges_AC())*serviceTax));
            this.ServiceTaxOnSurrenderCharges_RIY = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(Double.parseDouble(getSurrenderCharges_RIY()) * serviceTax));
        } else {
    ...
    public void setServiceTaxOnSurrenderCharges_RIY8(double serviceTax) {
        if (prop.surrenderChargesYield) {
            //this.serviceTaxOnSurrenderCharges_AD =cfap.roundUp_Level2(cfap.getStringWithout_E(Double.parseDouble(getSurrenderCharges_AC())*serviceTax));
            this.ServiceTaxOnSurrenderCharges_RIY8 = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(Double.parseDouble(getSurrenderCharges_RIY8()) * serviceTax));
        } else {
...
//       else
//       {a=0;}
//       this.serviceTaxOnFMC_AN = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(a* serviceTax));
//
        double a = 0, temp = 0;
        if (prop.fundManagementCharges) {
            a = 1;
        ...
        //this.serviceTaxOnFMC_Y = cfap.roundUp_Level2(cfap.getStringWithout_E(a* serviceTax));
        this.serviceTaxOnFMC_AN = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(temp * serviceTax * a));
    ...
    public void setTotalServiceTax_AJ(double riderCharges, double serviceTax) {
        ...
        this.totalServiceTax_AJ = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(temp1 + temp2 * serviceTax));
    }
...
//	        	System.out.println("cal RIY8 : "+cal);
    ...
    public void setServiceTaxOnSurrenderCharges_AS(double serviceTax) {
        if (prop.surrenderCharges) {
            this.serviceTaxOnSurrenderCharges_AS = cfap.getRoundOffLevel2New_Saral(cfap.getStringWithout_E(Double.parseDouble(getSurrenderCharges_AR()) * serviceTax));
        } else {
...
//       System.out.println("b_BU "+b);
    ...
    public void setReductionYield_BD(int policyTerm, double _FundValueAtEnd_RIY8, String returnOfMortalityChargeFinal) {
        double a, b;
...
//           System.out.println("inside if");
            ...
            a = _FundValueAtEnd_RIY8 + Double.parseDouble(returnOfMortalityChargeFinal);
        } else {
            a = 0;
        }
...
//      System.out.println("inside irr ");
        ...
        while (i < maxIterationCount) {
            ...
            for (int k = 0; k < values.size(); k++) {
             ...
             /* System.out.println("fValue after"+fValue);
       	   System.out.println("fDerivative after"+fDerivative);*/
            }

            // the essense of the Newton-Raphson Method
         /* System.out.println("x0 value"+x0);
          System.out.println("fValue final"+fValue);
   	   System.out.println("fDerivative final"+fDerivative);*/

            x1 = x0 - fValue / fDerivative;
          /*System.out.println("x1 value"+x1);
          System.out.println("condition value"+Math.abs(x1 - x0));
          System.out.println("absoluteAccuracy"+absoluteAccuracy);
          System.out.println("Month Counttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt");*/
    ...
    public double getCommistionRate(SmartInsureWealthPlusBean smartIinsurewealthPlusBean) {
        int findYear;
        ...
        if (smartIinsurewealthPlusBean.getIsForStaffOrNot()) {
            return 0;
        } else if (smartIinsurewealthPlusBean.getPlanType().equals("Limited")) {
            double[] lpptArr = {0.1, 0.02, 0.02, 0.02, 0.02, 0.015, 0.015, 0.01, 0.01, 0.01, 0};
            return lpptArr[findYear - 1];
        } else if (smartIinsurewealthPlusBean.getPlanType().equals("Single")) {
...
//			double []commArr = {0.13,0.02,0.02,0.02,0.02,0.02,0.02,0.02,0.02,0.02,0.02};
            double[] commArr = {0.08, 0.02, 0.02, 0.02, 0.02, 0.025, 0.025, 0.025, 0.025, 0.025, 0.03};
    ...
    public double getCommission_BL(double annualisesPrem, double topupPrem, SmartInsureWealthPlusBean smartIinsurewealthPlusBean) {
        double topup = 0;
        return getCommistionRate(smartIinsurewealthPlusBean) * annualisesPrem + (topupPrem * topup);
