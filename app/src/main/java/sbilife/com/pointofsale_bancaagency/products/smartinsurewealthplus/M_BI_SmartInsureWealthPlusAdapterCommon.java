...
public class M_BI_SmartInsureWealthPlusAdapterCommon {
    String policy_year = "";
    String premium = "";
    ...
    String tv_return_of_moratlity_charge1 = "";
    ...
    String tv_return_of_moratlity_charge2 = "";
    String surrender_value2 = "";
    String death_benefit2 = "";
    String commission = "";

    public M_BI_SmartInsureWealthPlusAdapterCommon(String policy_year, String premium, String mortality_charge1,
                                                   String total_charge1, String service_tax_on_mortality_charge1, String fund_value_at_end1, String tv_return_of_moratlity_charge1,
                                                   String surrender_value1, String death_benefit1, String mortality_charge2, String total_charge2,
                                                   String service_tax_on_mortality_charge2, String fund_value_at_end2, String tv_return_of_moratlity_charge2,
        ...
        this.tv_return_of_moratlity_charge1 = tv_return_of_moratlity_charge1;
        ...
        this.tv_return_of_moratlity_charge2 = tv_return_of_moratlity_charge2;
    ...
    public String getTv_return_of_moratlity_charge1() {
        return tv_return_of_moratlity_charge1;
    }

    public void setTv_return_of_moratlity_charge1(String tv_return_of_moratlity_charge1) {
        this.tv_return_of_moratlity_charge1 = tv_return_of_moratlity_charge1;
    }

    public String getTv_return_of_moratlity_charge2() {
        return tv_return_of_moratlity_charge2;
    }

    public void setTv_return_of_moratlity_charge2(String tv_return_of_moratlity_charge2) {
        this.tv_return_of_moratlity_charge2 = tv_return_of_moratlity_charge2;
    }
}
