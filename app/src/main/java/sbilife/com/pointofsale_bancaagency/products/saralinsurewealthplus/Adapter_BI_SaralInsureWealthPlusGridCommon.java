...
public class Adapter_BI_SaralInsureWealthPlusGridCommon extends BaseAdapter {
    ...
    List<M_BI_SaralInsureWealthPlusAdapterCommon> allElementDetails;
    ...
    public Adapter_BI_SaralInsureWealthPlusGridCommon(Context context, List<M_BI_SaralInsureWealthPlusAdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_saralinsurewealthplus_common,
                    null);
