...
class M_BI_SmartWomenAdvantageGrid_Adpter {
    ...
    private String critical_illness_gurantee = "";
    private String critical_illness_non_gurantee_4_percentage = "";
    private String critical_illness_non_gurantee_8_percentage = "";
    ...
    public M_BI_SmartWomenAdvantageGrid_Adpter(String policy_year, String death_gurantee,
                                               String benefit_payable_at_death_4_percentage,
                                               String benefit_payable_at_death_8_percentage,
                                               String critical_illness_gurantee,
                                               String critical_illness_non_gurantee_4_percentage,
                                               String critical_illness_non_gurantee_8_percentage,
        ...
        this.critical_illness_gurantee = critical_illness_gurantee;
        this.critical_illness_non_gurantee_4_percentage = critical_illness_non_gurantee_4_percentage;
        this.critical_illness_non_gurantee_8_percentage = critical_illness_non_gurantee_8_percentage;
    ...
    public String getCritical_illness_gurantee() {
        return critical_illness_gurantee;
    }

    public void setCritical_illness_gurantee(String critical_illness_gurantee) {
        this.critical_illness_gurantee = critical_illness_gurantee;
    }

    public String getCritical_illness_non_gurantee_4_percentage() {
        return critical_illness_non_gurantee_4_percentage;
    }

    public void setCritical_illness_non_gurantee_4_percentage(
            String critical_illness_non_gurantee_4_percentage) {
        this.critical_illness_non_gurantee_4_percentage = critical_illness_non_gurantee_4_percentage;
    }

    public String getCritical_illness_non_gurantee_8_percentage() {
        return critical_illness_non_gurantee_8_percentage;
    }

    public void setCritical_illness_non_gurantee_8_percentage(
            String critical_illness_non_gurantee_8_percentage) {
        this.critical_illness_non_gurantee_8_percentage = critical_illness_non_gurantee_8_percentage;
    }
