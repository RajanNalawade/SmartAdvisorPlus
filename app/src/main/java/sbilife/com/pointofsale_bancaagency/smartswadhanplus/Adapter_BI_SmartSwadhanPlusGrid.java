...
public class Adapter_BI_SmartSwadhanPlusGrid extends BaseAdapter {
    ...
    public final List<M_BI_Smart_Swadhan_Plus_Adapter> allElementDetails;
    // LayoutInflater mInflater;
    public final Context mContext;

    public final int[] colors = new int[]{Color.parseColor("#DCDBDB"),
            Color.parseColor("#E8E8E8")};
    //
    // private int[] colors = new int[] { Color.parseColor("#DCDBDB"),
    // Color.parseColor("#E8E8E8") };

    public Adapter_BI_SmartSwadhanPlusGrid(Context context, List<M_BI_Smart_Swadhan_Plus_Adapter> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_swadhan_plus,
                    null);
