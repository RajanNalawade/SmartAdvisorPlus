...
public class Adapter_BI_SmartBachatGridNew extends BaseAdapter {
    ...
    List<M_BI_SmartBachatNew_Adapter> allElementDetails;
    ...
    public Adapter_BI_SmartBachatGridNew(Context context, List<M_BI_SmartBachatNew_Adapter> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_bachat_new,
                    null);
