...
public class M_BI_RetireSmartAdapterCommon2 {
    String policy_year = "";
    String premium = "";
    ...
    String Guarantee_charge = "";
    String total_charge1 = "";
    String str_AddToTheFund4Pr = "";
    String Guaranteed_Addition = "";
    String Terminal_Addition = "";
    ...
    public M_BI_RetireSmartAdapterCommon2(String policy_year, String premium, String premium_allocation_charge, String annulized_premium_allocation_charge,
                                          String mortality_charge1, String service_tax_on_mortality_charge1, String policy_administration_charge, String Guarantee_charge,
                                          String total_charge1,
                                          String str_AddToTheFund4Pr, String Guaranteed_Addition, String Terminal_Addition, String fund_before_fmc1, String fund_management_charge1, String fund_value_at_end1,
    ...
    public String getGuarantee_charge() {
        return Guarantee_charge;
    }

    public void setGuarantee_charge(String guarantee_charge) {
    ...
    public void setGuaranteed_Addition(String guaranteed_Addition) {
        Guaranteed_Addition = guaranteed_Addition;
    }

    public String getTerminal_Addition() {
        return Terminal_Addition;
    }

    public void setTerminal_Addition(String terminal_Addition) {
