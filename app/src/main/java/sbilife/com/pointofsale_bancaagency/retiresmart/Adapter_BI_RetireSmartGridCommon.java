...
public class Adapter_BI_RetireSmartGridCommon extends BaseAdapter {
    ...
    List<M_BI_RetireSmartAdapterCommon> allElementDetails;
    ...
    public Adapter_BI_RetireSmartGridCommon(Context context, List<M_BI_RetireSmartAdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_retire_smart_common,
                    null);
