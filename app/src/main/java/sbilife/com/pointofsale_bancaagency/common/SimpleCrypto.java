...
/*
 * it will encrypt the data and decrypt the data while storing in database.
 */
...
public class SimpleCrypto {
	...
	/**
	 * The Builder used to create the SimpleEncryption instance and that contains the information about
	 * encryption specifications, this instance need to be private and careful managed
	 */
	private final Builder mBuilder;

	//private static String key = "$3creTQei";
	private static String salt = "SBILS@lt";
	private static byte[] iv = { -21, 58, 41, 124, -17, -19, 47, -35, 115, 120, -41, -7, 127, 103, -91, 8 };

	public static String encrypt(String strKey, String strData){
		SimpleCrypto siimpleEncryption = SimpleCrypto.getDefault(strKey, salt, iv);
		return siimpleEncryption.encryptOrNull(strData);
	}

	public static String decrypt(String strKey, String strData){
		SimpleCrypto siimpleEncryption = SimpleCrypto.getDefault(strKey, salt, iv);
		return siimpleEncryption.decryptOrNull(strData);
	}

	/**
	 * The private and unique constructor, you should use the SimpleEncryption.Builder to build your own
	 * instance or get the default proving just the sensible information about encryption
	 */
	private SimpleCrypto(Builder builder) {
		mBuilder = builder;
	}

	/**
	 * @return an default encryption instance or {@code null} if occur some Exception, you can
	 * create yur own SimpleEncryption instance using the SimpleEncryption.Builder
	 */
	public static SimpleCrypto getDefault(String key, String salt, byte[] iv) {
		try {
	...
	public String encrypt(String data) throws UnsupportedEncodingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, InvalidKeyException, InvalidKeySpecException, BadPaddingException, IllegalBlockSizeException {
		...
		return SimpleEncryptionBase64.encodeToString(cipher.doFinal(dataBytes), mBuilder.getBase64Mode());
	}
	...
	public String decrypt(String data) throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidAlgorithmParameterException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
		if (data == null) return null;
		byte[] dataBytes = SimpleEncryptionBase64.decode(data, mBuilder.getBase64Mode());
		SecretKey secretKey = getSecretKey(hashTheKey(mBuilder.getKey()));
		Cipher cipher = Cipher.getInstance(mBuilder.getAlgorithm());
	...
	private char[] hashTheKey(String key) throws UnsupportedEncodingException, NoSuchAlgorithmException {
		...
		return SimpleEncryptionBase64.encodeToString(messageDigest.digest(), SimpleEncryptionBase64.NO_PADDING).toCharArray();
	}
	...
	/**
	 * This class is used to create an SimpleEncryption instance, you should provide ALL data or start
	...
	public static class Builder {
		 ...
		 * the default base mode is SimpleEncryptionBase64
		...
		public static Builder getDefaultBuilder(String key, String salt, byte[] iv) {
			return new Builder()
					...
					.setBase64Mode(SimpleEncryptionBase64.DEFAULT)
		...
		/**
		 * Build the SimpleEncryption with the provided information
		 *
		 * @return a new SimpleEncryption instance with provided information
		 *
		 ...
		 */
		public SimpleCrypto build() throws NoSuchAlgorithmException {
			setSecureRandom(SecureRandom.getInstance(getSecureRandomAlgorithm()));
			setIvParameterSpec(new IvParameterSpec(getIv()));
			return new SimpleCrypto(this);
		}
