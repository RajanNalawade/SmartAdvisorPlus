...
public class AsyncUploadFile_Common extends AsyncTask<String, String, Boolean> {

    private final String NAMESPACE = "http://tempuri.org/",
            strSoapAction;

    private final ProgressDialog mProgressDialog;
    private final Interface_Upload_File_Common listener;
    private final CommonMethods mCommonMethods;
    private Context mContext;
    private SoapObject mRequest;

    //only for premitive results like 1 and 0
    public AsyncUploadFile_Common(Context mContext, Interface_Upload_File_Common listener, SoapObject mRequest,
    ...
    public interface Interface_Upload_File_Common {
