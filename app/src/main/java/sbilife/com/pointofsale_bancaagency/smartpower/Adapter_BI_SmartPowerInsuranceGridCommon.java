...
public class Adapter_BI_SmartPowerInsuranceGridCommon extends BaseAdapter {
    ...
    List<M_BI_SmartPowerInsuranceAdapterCommon> allElementDetails;
    ...
    public Adapter_BI_SmartPowerInsuranceGridCommon(Context context, List<M_BI_SmartPowerInsuranceAdapterCommon> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_power_insurance_common,
                    null);
