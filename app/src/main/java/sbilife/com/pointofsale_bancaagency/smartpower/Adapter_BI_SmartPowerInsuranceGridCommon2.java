...
public class Adapter_BI_SmartPowerInsuranceGridCommon2 extends BaseAdapter {
    ...
    List<M_BI_SmartPowerInsuranceAdapterCommon2> allElementDetails;
    ...
    public Adapter_BI_SmartPowerInsuranceGridCommon2(Context context, List<M_BI_SmartPowerInsuranceAdapterCommon2> results) {
...
//	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.adapter_bi_grid_smart_power_insurance_common2,
                    null);
