...
public class CarouselProductActivity extends AppCompatActivity {


    private TableLayout tblIndividual;
    private TableLayout tblHealth;
    private LinearLayout lnIndividual;
    private LinearLayout lnHealth;
    private Context con;
        ...
        savingPlansBanca.setOnItemSelectedListener(new OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (id != 0) {
                    ...
                    Intent i = new Intent(con, ProductDesc_webview.class);
                    i.putExtra("name", parent.getSelectedItem().toString());
//						i.putExtra("name","Smart Performer");
                    parent.setSelection(0);
                    startActivity(i);
...
//						i.putExtra("name","Smart Performer");
    ...
    public void onBackPressed() {
        Intent i = new Intent(CarouselProductActivity.this, CarouselHomeActivity.class);
